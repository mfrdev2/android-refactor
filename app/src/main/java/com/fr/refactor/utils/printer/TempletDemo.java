...
package com.fr.refactor.utils.printer;
...
public class TempletDemo {
    ...
    private TempletDemo(RTPrinter rtPrinter, Context context){
    ...
    public void EsctemplatePrint2()  {
        ...
        try {
            ...
            //  打印图标
            Bitmap bitLogo = BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher_round);
            if (bitLogo != null) {
                BitmapSetting bitmapSetting = new BitmapSetting();
